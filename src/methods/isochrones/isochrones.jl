...
function download_isochrone(family::Symbol, photsys::Symbol, age::NTuple{3,Number}, metal::NTuple{3,Number})::DataFrame
        ...
        if(family==:parsec)
                ...
                if(photsys==:hsc)
                        ...
                        if ezpadova_bool
                            ...
                            df = quickiso(log_age, metal) |> PyPandasDataFrame |> DataFrame
